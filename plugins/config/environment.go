...
const (
	...
	//ExportFormatKeyList format: a list of KEYs
	ExportFormatKeyList
...
func (e *Env) Export(format ExportFormat) string {
	...
	case ExportFormatKeyList:
		return e.KeyListString()
...
// KeyListString gets the contents of this Env in the form KEY KEY...
func (e *Env) KeyListString() string {
